  ...
  return (
    <div className="projects flex flex-col gap-y-5">
      <div className="projects-item flex flex-row justify-between gap-3 items-center">
        ...
        <img src={bagon} alt="penguin" className="w-48 hover:-translate-y-1.5 duration-500 pointer" onClick={redirectToBagon} />
      </div>

      <div className="projects-item flex flex-row justify-between gap-3 items-center project-item-alternate">
        <img src={tumble_ss} alt="penguin" className="w-48 hover:-translate-y-1.5 duration-500 pointer" onClick={redirectToTumble}/>
        <div className="project-text border bg-secondaryBG px-2 py-1">
      ...
      <div className="projects-item flex flex-row justify-between gap-3 items-center">
        ...
        <img src={singed_ss} alt="penguin" className="w-48 hover:-translate-y-1.5 duration-500 pointer" onClick={redirectToSinged}/>
      </div>
    </div>
  )
}