    ...
    <div className="aboutme flex flex-col ">
      <div className="flex flex-row gap-x-2 justify-between">
        <div className="aboutme-hello bg-secondaryBG border-2 max-w-xs px-2 pb-1">
          ...
          <p>
            Welcome to my personal site! My name is Patrick Choi and I am a
            fullstack software engineer living in the San Francisco Bay Area.
            I'm looking forward to growing my skills as an engineer and
            contributing to projects I find enjoyable! In my free time, I enjoy
            reading manga, playing sports, and taking pictures of my cat.
          </p>
        </div>
